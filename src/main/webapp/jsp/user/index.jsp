...
<body>
        ...
        <div class="nav-container">
            ...
            <div class="nav-right">
                ...
                <% 
                    ...
                    if (loginUser != null) { 
                %>
                    <%-- 已登录：显示头像+用户名，点击跳个人中心 --%>
                    <a href="${pageContext.request.contextPath}/jsp/user/user_center.jsp" class="flex items-center gap-2 group">
                        ...
                        <span class="hidden sm:inline text-sm text-gray-700 group-hover:text-primary transition-colors">
    ...
    <% if (successMsg != null && !successMsg.trim().isEmpty()) { %>
        <div class="bg-green-50 border-b border-green-200 py-2 text-center text-green-700 text-sm">
