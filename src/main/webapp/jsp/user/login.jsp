    ...
    <main class="flex-1 flex items-center justify-center py-10 px-4">
        <div class="w-full max-w-md bg-white rounded-2xl shadow-md p-8">
            ...
            <% if (successMsg != null && !successMsg.trim().isEmpty()) { %>
                <div class="mb-5 p-3 bg-green-50 border border-green-200 text-green-700 text-sm rounded-lg flex items-center justify-center">
            ...
            <% if (errMsg != null && !errMsg.trim().isEmpty()) { %>
                <div class="mb-5 p-3 bg-red-50 border border-red-200 text-red-600 text-sm rounded-lg flex items-center justify-center">
